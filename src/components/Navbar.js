          ...
          NavbarLinks.map ( (ele,index)=>{
            return(
              <div key={index}>
              {
                ...
                <div className='invisible z-40 w-[190px] absolute left-[50%] -top-[7%] gap-1 translate-x-[-50%] translate-y-[80%] flex flex-col  rounded-md bg-richblack-800 p-4 text-richblack-5 opacity-0 transition-all duration-200 group-hover:visible group-hover:opacity-100'>
                  {
                    links.map ( (ele,index) =>{
                      return (
                        <div key={index}>
