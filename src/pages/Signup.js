    ...
    <form onSubmit={handleOnSubmit} className='flex flex-row gap-5 mt-24 items-center w-11/12 justify-center bg-richblack-900 text-white mb-28'>
      <div className='flex flex-col gap-7 w-[50%] ml-24'>
        ...
        <div className='flex flex-row px-1 py-1 gap-2 items-center justify-evenly w-[27%] rounded-3xl cursor-pointer bg-richblack-800'>
          <p
            className={`font-normal cursor-pointer ${accountType === 'student' ? "bg-richblack-900 text-richblack-5" : "text-richblack-100"} hover:bg-richblack-700 text-richblack-5 px-3 py-1 rounded-2xl`}
            onClick={() => setaccountType('student')}
          >
            Student
          </p>
          <p
            className={`font-normal cursor-pointer ${accountType === 'instructor' ? "bg-richblack-900 text-richblack-5" : "text-richblack-100"} hover:bg-richblack-700 text-richblack-5 px-3 py-1 rounded-2xl`}
        ...
        <div className='flex flex-col gap-6 w-[70%]'>
          ...
          <button type="submit" className='bg-yellow-50 px-2 py-2 text-richblack-900 rounded-md' disabled={loading}>
