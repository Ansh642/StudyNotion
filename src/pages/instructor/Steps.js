  ...
  return (
    <div>
      <div className='flex flex-row gap-64 ml-10 rounded-full mt-10'>
            ...
            steps.map (  (ele,index)=>{
                return(
                    ...
                    <div className={`text-white`}>
                        <p className='text-sm text-richblack-100'>{ele.title}</p>
                    </div>
        ...
        {/* <button className='bg-yellow-50 w-20 rounded-lg px-5 py-2 border-b-[1px] border-white' onClick={()=>setstep(step+1)}>Next</button> */}
